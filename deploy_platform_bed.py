...
# 2. CATEGORIES — Mattresses & Bedding (after best-mattress-no-box-spring)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-no-box-spring'",
        "'best-mattress-no-box-spring', 'best-mattress-platform-bed'"
    )
...
card_check = 'href="posts/best-mattress-platform-bed.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Mattresses &amp; Bedding</span>\n'
    '          <h3><a href="posts/best-mattress-platform-bed.html">Best Mattress for Platform Beds</a></h3>\n'
    '          <p>7 picks with slat spacing rules &mdash; max gap guide by mattress type, height compatibility table, and frame-by-frame compatibility chart.</p>\n'
