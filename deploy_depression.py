...
# 2. CATEGORIES -- Health Conditions (after best-mattress-endometriosis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-endometriosis'",
        "'best-mattress-endometriosis', 'best-mattress-depression'"
    )
...
card_check = 'href="posts/best-mattress-depression.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-depression.html">Best Mattress for Depression</a></h3>\n'
    '          <p>7 picks for depression-related sleep &mdash; hypersomnia vs early morning awakening, REM changes, antidepressant night sweats, psychomotor retardation &amp; the sleep-mood bidirectional link.</p>\n'
