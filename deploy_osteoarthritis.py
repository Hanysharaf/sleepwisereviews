slug = "best-mattress-osteoarthritis"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-epilepsy)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-epilepsy'",
        "'best-mattress-epilepsy', 'best-mattress-osteoarthritis'"
    )
...
card_check = 'href="posts/best-mattress-osteoarthritis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-osteoarthritis.html">Best Mattress for Osteoarthritis</a></h3>\n'
    '          <p>7 picks for OA joint pain &mdash; hip, knee &amp; spinal osteoarthritis, morning stiffness, zoned pressure relief &amp; NSAID sleep effects.</p>\n'
