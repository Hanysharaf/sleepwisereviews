...
# 2. CATEGORIES — Health Conditions (after best-mattress-insomnia)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-insomnia'",
        "'best-mattress-insomnia', 'best-mattress-spinal-stenosis'"
    )
...
card_check = 'href="posts/best-mattress-spinal-stenosis.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-spinal-stenosis.html">Best Mattress for Spinal Stenosis</a></h3>\n'
    '          <p>7 mattresses chosen to reduce nerve compression at night &mdash; sleep position guide, firmness by stenosis type, and adjustable base comparison.</p>\n'
