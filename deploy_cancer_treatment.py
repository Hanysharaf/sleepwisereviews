slug = "best-mattress-cancer-treatment"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-hypothyroidism)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-hypothyroidism'",
        "'best-mattress-hypothyroidism', 'best-mattress-cancer-treatment'"
    )
...
card_check = 'href="posts/best-mattress-cancer-treatment.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-cancer-treatment.html">Best Mattress During Cancer Treatment</a></h3>\n'
    '          <p>7 picks for chemo &amp; radiation sleep &mdash; peripheral neuropathy, bone pain, treatment fatigue, immune compromise, hot flashes &amp; steroid-induced insomnia.</p>\n'
