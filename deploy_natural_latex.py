slug = "best-natural-latex-mattress"
...
if slug not in gen:
    # Insert in Mattresses & Bedding after best-latex-mattress
    gen = gen.replace(
        "'best-latex-mattress'",
        "'best-latex-mattress', 'best-natural-latex-mattress'"
    )
...
card_check = 'href="posts/best-natural-latex-mattress.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Mattresses &amp; Bedding</span>\n'
    '          <h3><a href="posts/best-natural-latex-mattress.html">Best Natural Latex Mattress</a></h3>\n'
    '          <p>7 GOLS-certified organic latex picks &mdash; ranked for durability, pressure relief, and value. Dunlop vs. Talalay guide, certification breakdown, lifespan math.</p>\n'
