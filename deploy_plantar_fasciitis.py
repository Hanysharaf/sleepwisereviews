slug = "best-mattress-plantar-fasciitis"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-diabetes)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-diabetes'",
        "'best-mattress-diabetes', 'best-mattress-plantar-fasciitis'"
    )
...
card_check = 'href="posts/best-mattress-plantar-fasciitis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-plantar-fasciitis.html">Best Mattress for Plantar Fasciitis</a></h3>\n'
    '          <p>7 picks for heel &amp; arch pain relief &mdash; edge firmness for barefoot exit, overnight calcaneal pressure, heel spur cushioning &amp; the morning pain protocol.</p>\n'
