...
# 2. CATEGORIES -- Health Conditions (after best-mattress-bipolar)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-bipolar'",
        "'best-mattress-bipolar', 'best-mattress-autism'"
    )
...
card_check = 'href="posts/best-mattress-autism.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-autism.html">Best Mattress for Autism</a></h3>\n'
    '          <p>7 sensory-safe picks for autism sleep &mdash; tactile defensiveness, proprioceptive seeking, deep pressure therapy, chemical sensitivity &amp; ASD-specific sleep disruption.</p>\n'
