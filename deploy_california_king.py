slug = "best-california-king-mattress"
...
if slug not in gen:
    # Insert in Mattresses & Bedding after best-king-mattress
    gen = gen.replace(
        "'best-king-mattress'",
        "'best-king-mattress', 'best-california-king-mattress'"
    )
...
card_check = 'href="posts/best-california-king-mattress.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Mattresses &amp; Bedding</span>\n'
    '          <h3><a href="posts/best-california-king-mattress.html">Best California King Mattress</a></h3>\n'
    '          <p>7 top Cal King picks for tall sleepers &mdash; 4 inches longer than a standard king. Size guide, comparison table, and ranked options for every budget.</p>\n'
