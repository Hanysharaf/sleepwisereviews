...
# 2. CATEGORIES -- Health Conditions (after best-mattress-adhd)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-adhd'",
        "'best-mattress-adhd', 'best-mattress-asthma'"
    )
...
card_check = 'href="posts/best-mattress-asthma.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-asthma.html">Best Mattress for Asthma</a></h3>\n'
    '          <p>7 picks for asthma sleep &mdash; allergen elimination, VOC-free materials, nocturnal bronchoconstriction, GERD overlap elevation &amp; dust mite barrier design.</p>\n'
