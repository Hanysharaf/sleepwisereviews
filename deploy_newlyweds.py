...
# 2. CATEGORIES — Life Stages (after best-mattress-teenager)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-teenager'",
        "'best-mattress-teenager', 'best-mattress-newlyweds'"
    )
...
card_check = 'href="posts/best-mattress-newlyweds.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-newlyweds.html">Best Mattress for Newlyweds</a></h3>\n'
    '          <p>7 picks for your first bed together &mdash; motion isolation, temperature compromise, Queen vs King guide, wedding registry strategy, and picks for every budget.</p>\n'
