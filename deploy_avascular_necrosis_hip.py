...
# 2. CATEGORIES -- Health Conditions (after best-mattress-thoracic-outlet-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-thoracic-outlet-syndrome'",
        "'best-mattress-thoracic-outlet-syndrome', 'best-mattress-avascular-necrosis-hip'"
    )
...
card_check = 'href="posts/best-mattress-avascular-necrosis-hip.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-avascular-necrosis-hip.html">Best Mattress for Avascular Necrosis of the Hip</a></h3>\n'
    '          <p>7 picks for AVN hip &mdash; sub-32mmHg femoral head pressure, zero-gravity bilateral offloading, steroid-induced AVN chemical safety, Stage III-IV collapsed anatomy contouring &amp; THA posterior precautions.</p>\n'
