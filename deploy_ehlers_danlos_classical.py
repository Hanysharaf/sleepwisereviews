slug = "best-mattress-ehlers-danlos-classical"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-interstitial-lung-disease)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-interstitial-lung-disease'",
        "'best-mattress-interstitial-lung-disease', 'best-mattress-ehlers-danlos-classical'"
    )
...
card_check = 'href="posts/best-mattress-ehlers-danlos-classical.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-ehlers-danlos-classical.html">Best Mattress for Classical EDS</a></h3>\n'
    '          <p>7 picks for cEDS &mdash; sub-32mmHg skin fragility protection, sleep subluxation prevention, multi-joint zoned support, GOLS latex buoyancy &amp; proprioceptive repositioning.</p>\n'
