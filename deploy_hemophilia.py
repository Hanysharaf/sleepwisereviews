...
# 2. CATEGORIES -- Health Conditions (after best-mattress-myasthenia-gravis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-myasthenia-gravis'",
        "'best-mattress-myasthenia-gravis', 'best-mattress-hemophilia'"
    )
...
card_check = 'href="posts/best-mattress-hemophilia.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-hemophilia.html">Best Mattress for Hemophilia</a></h3>\n'
    '          <p>7 picks for hemophilia &mdash; target joint protection at knees/ankles/elbows, nocturnal factor trough pressure management, hemarthrosis RICE elevation, safe low-effort transfer &amp; inhibitor-safe materials.</p>\n'
