...
# 2. CATEGORIES -- Health Conditions (after best-mattress-pelvic-floor-dysfunction)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-pelvic-floor-dysfunction'",
        "'best-mattress-pelvic-floor-dysfunction', 'best-mattress-dysautonomia'"
    )
...
card_check = 'href="posts/best-mattress-dysautonomia.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-dysautonomia.html">Best Mattress for Dysautonomia</a></h3>\n'
    '          <p>7 picks for dysautonomia &mdash; supine hypertension head elevation, anhydrosis passive cooling, small fiber neuropathy allodynia, MSA RBD &amp; hEDS-associated autonomic instability.</p>\n'
