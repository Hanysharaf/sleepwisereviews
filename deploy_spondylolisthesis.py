slug = "best-mattress-spondylolisthesis"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-polymyositis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-polymyositis'",
        "'best-mattress-polymyositis', 'best-mattress-spondylolisthesis'"
    )
...
card_check = 'href="posts/best-mattress-spondylolisthesis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-spondylolisthesis.html">Best Mattress for Spondylolisthesis</a></h3>\n'
    '          <p>7 picks for vertebral slip &mdash; motorized knee elevation reducing anterior shear at L4-L5/L5-S1, Lumbar Zone for pars defect, Grade I-III slip positioning protocol &amp; anti-hyperextension support.</p>\n'
