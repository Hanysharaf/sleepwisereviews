...
CATEGORIES = {
    ...
    'Health Conditions': ['sleep-apnea-warning-signs', 'sleep-apnea-diagnosis', 'home-sleep-apnea-test', 'snoring-causes-fixes', 'restless-legs-syndrome', 'sleep-chronic-pain', 'sleep-fibromyalgia', 'sleep-and-pain', 'sleep-depression', 'sleep-mental-health', 'sleep-heart-health', 'sleep-and-diabetes', 'sleep-and-alzheimers', 'sleep-autism-spectrum', 'bad-mattress-health-effects', 'sleep-after-surgery', 'sleep-skin-health', 'sleep-after-covid', 'best-mouthguard-teeth-grinding', 'best-cpap-mask-side-sleepers', 'best-pillow-for-cervical-spondylosis', 'best-mattress-fibromyalgia', 'best-anti-snoring-pillow'],
    'Life Stages': ['pregnancy-sleep-guide', 'kids-sleep-guide', 'kids-screen-time-sleep', 'teen-sleep-guide', 'aging-and-sleep', 'women-sleep-differences', 'menopause-sleep', 'sleep-menstrual-cycle', 'sleep-new-baby', 'couples-sleep-problems', 'best-pregnancy-pillows', 'best-body-pillow', 'best-white-noise-machine-baby', 'best-crib-mattress', 'best-toddler-pillow', 'best-baby-monitor-sleep', 'best-weighted-blanket-kids', 'best-kids-alarm-clock', 'best-mattress-for-seniors', 'best-mattress-topper-seniors'],
