...
CATEGORIES = {
    ...
    'Health Conditions': ['sleep-apnea-warning-signs', 'sleep-apnea-diagnosis', 'home-sleep-apnea-test', 'snoring-causes-fixes', 'restless-legs-syndrome', 'sleep-chronic-pain', 'sleep-fibromyalgia', 'sleep-and-pain', 'sleep-depression', 'sleep-mental-health', 'sleep-heart-health', 'sleep-and-diabetes', 'sleep-and-alzheimers', 'sleep-autism-spectrum', 'bad-mattress-health-effects', 'sleep-after-surgery', 'sleep-skin-health', 'sleep-after-covid', 'best-mouthguard-teeth-grinding', 'best-cpap-mask-side-sleepers', 'best-pillow-for-cervical-spondylosis', 'best-mattress-fibromyalgia', 'best-anti-snoring-pillow', 'best-cpap-humidifier', 'best-pillow-for-side-sleepers-shoulder-pain', 'best-cpap-machine-travel', 'best-mattress-sciatica'],
