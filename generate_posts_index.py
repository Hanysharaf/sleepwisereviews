...
CATEGORIES = {
    ...
    'Life Stages': ['pregnancy-sleep-guide', 'kids-sleep-guide', 'kids-screen-time-sleep', 'teen-sleep-guide', 'aging-and-sleep', 'women-sleep-differences', 'menopause-sleep', 'sleep-menstrual-cycle', 'sleep-new-baby', 'couples-sleep-problems', 'best-pregnancy-pillows'],
    'Timing & Jet Lag': ['reset-sleep-schedule', 'jet-lag-guide', 'sleep-travel-tips', 'sleep-business-travel', 'social-jetlag', 'daylight-saving-sleep', 'shift-work-shift', 'night-shift-optimization', 'polyphasic-sleep', 'polyphasic-sleep-schedules', 'sleep-consistency-importance', 'weekend-sleep-mistake', 'wrong-sleeping-in-weekends', 'shift-work-sleep'],
    ...
    'Mattresses & Bedding': ['best-mattresses-back-pain', 'best-mattresses-couples-2026', 'best-mattress-toppers', 'best-cooling-mattress-pads', 'best-cooling-pillows', 'best-cooling-sheets', 'best-mattress-stomach-sleepers', 'best-mattress-side-sleepers', 'best-pillow-sleep-position', 'best-pillow-side-sleepers', 'best-pillow-neck-pain', 'best-grounding-sheets', 'mattress-buying-guide', 'memory-foam-vs-hybrid-mattress', 'best-mattresses-under-500', 'best-smart-mattresses'],
    'Sleep Products': ['best-sleep-masks', 'best-blackout-curtains', 'best-humidifiers-sleep', 'best-sleep-headphones', 'article-white-noise-machines', 'best-white-noise-machines-sleeping', 'best-light-therapy-lamps', 'best-blue-light-glasses', 'best-aromatherapy-sleep', 'best-cpap-alternatives', 'article-weighted-blanket', 'best-anti-snoring-devices', 'best-sleep-monitors', 'best-sleep-apps', 'best-sleep-tracking-rings', 'best-earplugs-sleeping', 'best-sunrise-alarm-clocks'],
    'Supplements': ['best-melatonin-supplements', 'best-sleep-supplements-guide', 'best-valerian-root-supplements', 'article-magnesium-sleep', 'sleep-medications-truth'],
}
