...
# 2. CATEGORIES -- Health Conditions (after best-mattress-asthma)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-asthma'",
        "'best-mattress-asthma', 'best-mattress-bipolar'"
    )
...
card_check = 'href="posts/best-mattress-bipolar.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-bipolar.html">Best Mattress for Bipolar Disorder</a></h3>\n'
    '          <p>7 picks for bipolar sleep &mdash; manic-phase thermal dysregulation, depressive-phase hypersomnia, mood-cycle variability &amp; medication-altered sleep architecture.</p>\n'
