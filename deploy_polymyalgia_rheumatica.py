slug = "best-mattress-polymyalgia-rheumatica"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-sjogrens-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-sjogrens-syndrome'",
        "'best-mattress-sjogrens-syndrome', 'best-mattress-polymyalgia-rheumatica'"
    )
...
card_check = 'href="posts/best-mattress-polymyalgia-rheumatica.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-polymyalgia-rheumatica.html">Best Mattress for Polymyalgia Rheumatica</a></h3>\n'
    '          <p>7 picks for PMR &mdash; bilateral shoulder/hip girdle bursitis, severe morning stiffness, steroid-induced insomnia, CIOP osteoporosis risk &amp; elderly sleep physiology.</p>\n'
