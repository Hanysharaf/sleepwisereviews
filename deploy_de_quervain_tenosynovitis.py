...
# 2. CATEGORIES (after best-mattress-golfers-elbow)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-golfers-elbow'",
        "'best-mattress-golfers-elbow', 'best-mattress-de-quervain-tenosynovitis'"
    )
...
card_check = 'href="posts/best-mattress-de-quervain-tenosynovitis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-de-quervain-tenosynovitis.html">Best Mattress for De Quervain\'s Tenosynovitis</a></h3>\n'
    '          <p>7 picks for first dorsal compartment inflammation &mdash; radial styloid pressure prevention, Finkelstein wrist-drift avoidance during REM, thumb-neutral positioning &amp; postpartum new-mother management.</p>\n'
