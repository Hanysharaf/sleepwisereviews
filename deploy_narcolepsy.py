...
# 2. CATEGORIES -- Health Conditions (after best-mattress-sleep-apnea)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-sleep-apnea'",
        "'best-mattress-sleep-apnea', 'best-mattress-narcolepsy'"
    )
...
card_check = 'href="posts/best-mattress-narcolepsy.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-narcolepsy.html">Best Mattress for Narcolepsy</a></h3>\n'
    '          <p>7 picks for narcolepsy &mdash; cataplexy fall safety, REM intrusion, hypnagogic hallucinations, orexin temperature dysregulation &amp; sodium oxybate dosing needs.</p>\n'
