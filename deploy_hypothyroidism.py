slug = "best-mattress-hypothyroidism"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-interstitial-cystitis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-interstitial-cystitis'",
        "'best-mattress-interstitial-cystitis', 'best-mattress-hypothyroidism'"
    )
...
card_check = 'href="posts/best-mattress-hypothyroidism.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-hypothyroidism.html">Best Mattress for Hypothyroidism</a></h3>\n'
    '          <p>7 picks for underactive thyroid sleep &mdash; cold sensitivity, non-restorative hypersomnia, weight gain pressure needs, restless legs comorbidity &amp; medication titration.</p>\n'
