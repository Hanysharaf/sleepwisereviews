...
# 2. CATEGORIES -- Health Conditions (after best-mattress-gout)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-gout'",
        "'best-mattress-gout', 'best-mattress-hiv-aids'"
    )
...
card_check = 'href="posts/best-mattress-hiv-aids.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-hiv-aids.html">Best Mattress for HIV/AIDS</a></h3>\n'
    '          <p>7 picks for HIV sleep &mdash; antiretroviral drug effects, lipodystrophy, buffalo hump, night sweats, neuropathy &amp; immune-safe materials.</p>\n'
