...
# 2. CATEGORIES (after best-mattress-small-fiber-neuropathy)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-small-fiber-neuropathy'",
        "'best-mattress-small-fiber-neuropathy', 'best-mattress-intracranial-hypertension'"
    )
...
card_check = 'href="posts/best-mattress-intracranial-hypertension.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-intracranial-hypertension.html">Best Mattress for Intracranial Hypertension</a></h3>\n'
    '          <p>7 picks for pseudotumor cerebri &mdash; 30-45 deg motorized head elevation for CSF pressure relief, jugular vein compression prevention, sleep apnea co-management &amp; morning headache reduction.</p>\n'
