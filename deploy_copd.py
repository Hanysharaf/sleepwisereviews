...
# 2. CATEGORIES -- Health Conditions (after best-mattress-plantar-fasciitis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-plantar-fasciitis'",
        "'best-mattress-plantar-fasciitis', 'best-mattress-copd'"
    )
...
card_check = 'href="posts/best-mattress-copd.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-copd.html">Best Mattress for COPD</a></h3>\n'
    '          <p>7 picks for COPD, emphysema &amp; chronic bronchitis &mdash; head elevation guide, diaphragmatic pressure relief, adjustable base compatibility &amp; overlap syndrome management.</p>\n'
