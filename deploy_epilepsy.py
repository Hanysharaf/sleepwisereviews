...
# 2. CATEGORIES -- Health Conditions (after best-mattress-cancer-treatment)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-cancer-treatment'",
        "'best-mattress-cancer-treatment', 'best-mattress-epilepsy'"
    )
...
card_check = 'href="posts/best-mattress-epilepsy.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-epilepsy.html">Best Mattress for Epilepsy</a></h3>\n'
    '          <p>7 picks for epilepsy sleep &mdash; nocturnal seizure safety, SUDEP risk reduction, recovery position support, AED medication effects &amp; sleep deprivation seizure threshold.</p>\n'
