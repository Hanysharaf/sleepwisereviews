...
# 2. CATEGORIES -- Health Conditions (after best-mattress-lyme-disease)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-lyme-disease'",
        "'best-mattress-lyme-disease', 'best-mattress-mcas'"
    )
...
card_check = 'href="posts/best-mattress-mcas.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-mcas.html">Best Mattress for MCAS</a></h3>\n'
    '          <p>7 picks for MCAS &mdash; VOC chemical triggers, nocturnal histamine peaks, physical pressure sensitivity, temperature dysregulation &amp; MCAS-POTS-hEDS triad.</p>\n'
