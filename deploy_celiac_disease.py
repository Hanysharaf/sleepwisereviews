...
# 2. CATEGORIES -- Health Conditions (after best-mattress-raynauds)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-raynauds'",
        "'best-mattress-raynauds', 'best-mattress-celiac-disease'"
    )
...
card_check = 'href="posts/best-mattress-celiac-disease.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-celiac-disease.html">Best Mattress for Celiac Disease</a></h3>\n'
    '          <p>7 picks for celiac &mdash; dermatitis herpetiformis contact itch, iron-deficiency RLS, gluten neuropathy burning, celiac arthropathy &amp; nutritional recovery sleep.</p>\n'
