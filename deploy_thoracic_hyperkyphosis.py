...
# 2. CATEGORIES (after best-mattress-syringomyelia)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-syringomyelia'",
        "'best-mattress-syringomyelia', 'best-mattress-thoracic-hyperkyphosis'"
    )
...
card_check = 'href="posts/best-mattress-thoracic-hyperkyphosis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-thoracic-hyperkyphosis.html">Best Mattress for Thoracic Hyperkyphosis</a></h3>\n'
    '          <p>7 picks for Scheuermann\'s kyphosis &mdash; thoracic wedge contouring, shoulder-blade surface adaptation, rib cage expansion support &amp; forced-flat-spine avoidance.</p>\n'
