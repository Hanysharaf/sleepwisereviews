...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-sciatica', 'best-mattress-herniated-disc'"
    )
...
card_check = 'href="posts/best-mattress-herniated-disc.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-herniated-disc.html">Best Mattress for Herniated Disc</a></h3>\n'
    '          <p>7 mattresses for L4-L5, L5-S1, and cervical disc relief &mdash; firmness guide by disc location, sleep position protocol, and zero-gravity adjustable base setup.</p>\n'
