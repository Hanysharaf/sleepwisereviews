slug = "best-mattress-ankylosing-spondylitis"
...
# 2. CATEGORIES — Health Conditions (after best-mattress-multiple-sclerosis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-multiple-sclerosis'",
        "'best-mattress-multiple-sclerosis', 'best-mattress-ankylosing-spondylitis'"
    )
...
card_check = 'href="posts/best-mattress-ankylosing-spondylitis.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-ankylosing-spondylitis.html">Best Mattress for Ankylosing Spondylitis</a></h3>\n'
    '          <p>7 picks for AS morning stiffness &amp; inflammatory back pain &mdash; medium-firm spinal support, repositioning ease, and an AS stage guide. AS is the opposite of mechanical back pain.</p>\n'
