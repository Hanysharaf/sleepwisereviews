...
# 2. CATEGORIES -- Health Conditions (after best-mattress-spinal-stenosis-cervical)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-spinal-stenosis-cervical'",
        "'best-mattress-spinal-stenosis-cervical', 'best-mattress-marfan-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-marfan-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-marfan-syndrome.html">Best Mattress for Marfan Syndrome</a></h3>\n'
    '          <p>7 picks for Marfan syndrome &mdash; California king tall-frame support, dural ectasia sacral pressure relief, thoracolumbar scoliosis zones, aortic-safe positioning &amp; joint hypermobility stabilization.</p>\n'
