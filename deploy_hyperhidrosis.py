...
# 2. CATEGORIES (after best-mattress-thoracic-hyperkyphosis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-thoracic-hyperkyphosis'",
        "'best-mattress-thoracic-hyperkyphosis', 'best-mattress-hyperhidrosis'"
    )
...
card_check = 'href="posts/best-mattress-hyperhidrosis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-hyperhidrosis.html">Best Mattress for Hyperhidrosis</a></h3>\n'
    '          <p>7 picks for excessive sleep sweating &mdash; moisture-wicking cover science, open-cell airflow vs. innerspring, phase-change material ratings &amp; mattress hygiene for chronic sweat exposure.</p>\n'
