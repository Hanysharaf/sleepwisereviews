...
# 2. CATEGORIES -- Health Conditions (after best-mattress-piriformis-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-piriformis-syndrome'",
        "'best-mattress-piriformis-syndrome', 'best-mattress-venous-insufficiency'"
    )
...
card_check = 'href="posts/best-mattress-venous-insufficiency.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-venous-insufficiency.html">Best Mattress for Venous Insufficiency</a></h3>\n'
    '          <p>7 picks for CVI &mdash; leg elevation for venous return, varicose vein pressure relief, calf &amp; heel protection, dependent edema reduction &amp; split-king for partner independence.</p>\n'
