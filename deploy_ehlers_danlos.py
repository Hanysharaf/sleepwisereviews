...
# 2. CATEGORIES — Health Conditions (after best-mattress-ankylosing-spondylitis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-ankylosing-spondylitis'",
        "'best-mattress-ankylosing-spondylitis', 'best-mattress-ehlers-danlos'"
    )
...
card_check = 'href="posts/best-mattress-ehlers-danlos.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-ehlers-danlos.html">Best Mattress for Ehlers-Danlos Syndrome</a></h3>\n'
    '          <p>7 picks for hEDS joint instability &amp; hypermobility &mdash; medium-firm support, proprioception deficit explained, joint positioning system for side sleepers.</p>\n'
