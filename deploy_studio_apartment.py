...
# 2. CATEGORIES — Life Stages (after best-mattress-heavy-sleepers)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-heavy-sleepers'",
        "'best-mattress-heavy-sleepers', 'best-mattress-studio-apartment'"
    )
...
card_check = 'href="posts/best-mattress-studio-apartment.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-studio-apartment.html">Best Mattress for Studio Apartment</a></h3>\n'
    '          <p>7 mattresses for space-constrained living &mdash; size guide by room sq ft, delivery logistics, and multi-use setup tips for studio apartments.</p>\n'
