slug = "best-mattress-spinal-cord-injury"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-inflammatory-bowel-disease)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-inflammatory-bowel-disease'",
        "'best-mattress-inflammatory-bowel-disease', 'best-mattress-spinal-cord-injury'"
    )
...
card_check = 'href="posts/best-mattress-spinal-cord-injury.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-spinal-cord-injury.html">Best Mattress for Spinal Cord Injury</a></h3>\n'
    '          <p>7 picks for SCI &mdash; pressure injury prevention, autonomic dysreflexia risk, spasticity, poikilothermia &amp; wheelchair transfer height.</p>\n'
