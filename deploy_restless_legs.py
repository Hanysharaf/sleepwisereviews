slug = "best-mattress-restless-legs"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-rheumatoid-arthritis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-rheumatoid-arthritis'",
        "'best-mattress-rheumatoid-arthritis', 'best-mattress-restless-legs'"
    )
...
card_check = 'href="posts/best-mattress-restless-legs.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-restless-legs.html">Best Mattress for Restless Legs Syndrome</a></h3>\n'
    '          <p>7 picks for RLS &amp; Willis-Ekbom disease &mdash; motion isolation for partner disruption, cooling as symptoms peak 9 PM&ndash;4 AM, edge support for nighttime exits.</p>\n'
