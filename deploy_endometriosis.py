slug = "best-mattress-endometriosis"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-pcos)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-pcos'",
        "'best-mattress-pcos', 'best-mattress-endometriosis'"
    )
...
card_check = 'href="posts/best-mattress-endometriosis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-endometriosis.html">Best Mattress for Endometriosis</a></h3>\n'
    '          <p>7 picks for endometriosis pelvic pain &amp; sleep &mdash; adhesion pressure relief, fetal position support, prostaglandin inflammatory cycles &amp; the pain-sleep bidirectional relationship.</p>\n'
