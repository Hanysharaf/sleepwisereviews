...
# 2. CATEGORIES -- Health Conditions (after best-mattress-migraines)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-migraines'",
        "'best-mattress-migraines', 'best-mattress-diabetes'"
    )
...
card_check = 'href="posts/best-mattress-diabetes.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-diabetes.html">Best Mattress for Diabetes</a></h3>\n'
    '          <p>7 picks for T1DM &amp; T2DM &mdash; diabetic neuropathy foot pressure relief, nocturia exit ease, nocturnal hypoglycemia cooling, and the sleep-glucose bidirectional relationship.</p>\n'
