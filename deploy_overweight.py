...
if slug not in gen:
    # Insert in Life Stages after best-mattress-college-students
    gen = gen.replace(
        "'best-mattress-college-students'",
        "'best-mattress-college-students', 'best-mattress-overweight'"
    )
...
card_check = 'href="posts/best-mattress-overweight.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-overweight.html">Best Mattress for Overweight Sleepers</a></h3>\n'
    '          <p>7 mattresses built for heavier sleepers — rated on weight limits, edge support, durability, and pressure relief for bodies over 230 lbs.</p>\n'
