slug = "best-mattress-post-laminectomy-syndrome"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-venous-insufficiency)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-venous-insufficiency'",
        "'best-mattress-venous-insufficiency', 'best-mattress-post-laminectomy-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-post-laminectomy-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-post-laminectomy-syndrome.html">Best Mattress for Post-Laminectomy Syndrome</a></h3>\n'
    '          <p>7 picks for failed back surgery syndrome &mdash; epidural fibrosis positioning, adjacent segment disease protection, SCS compatibility, spinal instability management &amp; central sensitization pressure relief.</p>\n'
