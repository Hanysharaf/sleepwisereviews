...
# 2. CATEGORIES — Life Stages (after best-mattress-petite-sleeper)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-petite-sleeper'",
        "'best-mattress-petite-sleeper', 'best-mattress-heavy-sleepers'"
    )
...
card_check = 'href="posts/best-mattress-heavy-sleepers.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-heavy-sleepers.html">Best Mattress for Heavy Sleepers</a></h3>\n'
    '          <p>7 mattresses built for 250+ lbs &mdash; coil gauge guide, durability ratings, and weight-band firmness table for back, side, and stomach sleepers.</p>\n'
