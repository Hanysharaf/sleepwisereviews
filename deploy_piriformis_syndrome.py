slug = "best-mattress-piriformis-syndrome"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-shoulder-impingement)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-shoulder-impingement'",
        "'best-mattress-shoulder-impingement', 'best-mattress-piriformis-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-piriformis-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-piriformis-syndrome.html">Best Mattress for Piriformis Syndrome</a></h3>\n'
    '          <p>7 picks for piriformis syndrome &mdash; sciatic nerve decompression at the deep gluteal space, hip rotation control, piriformis pressure relief &amp; back-sleep positioning distinct from lumbar sciatica.</p>\n'
