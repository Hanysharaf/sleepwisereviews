...
# 2. CATEGORIES (after best-mattress-meralgia-paresthetica)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-meralgia-paresthetica'",
        "'best-mattress-meralgia-paresthetica', 'best-mattress-achilles-tendinopathy'"
    )
...
card_check = 'href="posts/best-mattress-achilles-tendinopathy.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-achilles-tendinopathy.html">Best Mattress for Achilles Tendinopathy</a></h3>\n'
    '          <p>7 picks for Achilles tendinopathy &mdash; sub-32mmHg calcaneal insertion pressure relief, leg elevation for tendon repair, insertional vs. mid-body positioning protocol &amp; nocturnal equinus prevention.</p>\n'
