...
# 2. CATEGORIES — Health Conditions (after best-mattress-lupus)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-lupus'",
        "'best-mattress-lupus', 'best-mattress-multiple-sclerosis'"
    )
...
card_check = 'href="posts/best-mattress-multiple-sclerosis.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-multiple-sclerosis.html">Best Mattress for Multiple Sclerosis</a></h3>\n'
    '          <p>7 picks for MS spasticity, heat sensitivity &amp; fatigue &mdash; cooling to prevent Uhthoff&rsquo;s phenomenon, edge support for mobility, and an MS stage guide.</p>\n'
