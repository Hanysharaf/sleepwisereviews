...
# 2. CATEGORIES -- Health Conditions (after best-mattress-tourette-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-tourette-syndrome'",
        "'best-mattress-tourette-syndrome', 'best-mattress-pelvic-floor-dysfunction'"
    )
...
card_check = 'href="posts/best-mattress-pelvic-floor-dysfunction.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-pelvic-floor-dysfunction.html">Best Mattress for Pelvic Floor Dysfunction</a></h3>\n'
    '          <p>7 picks for PFD &mdash; pelvic alignment, hypertonicity relief, prolapse support, nocturia transfers, IC overlap &amp; postpartum recovery.</p>\n'
