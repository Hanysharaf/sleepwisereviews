slug = "best-mattress-crohns-disease"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-narcolepsy)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-narcolepsy'",
        "'best-mattress-narcolepsy', 'best-mattress-crohns-disease'"
    )
...
card_check = 'href="posts/best-mattress-crohns-disease.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-crohns-disease.html">Best Mattress for Crohn\'s Disease</a></h3>\n'
    '          <p>7 picks for Crohn\'s &mdash; nocturnal urgency positioning, zero-gravity abdominal pressure relief, perianal disease comfort, malnutrition pressure injury risk &amp; flare-remission lifecycle.</p>\n'
