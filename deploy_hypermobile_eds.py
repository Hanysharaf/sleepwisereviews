slug = "best-mattress-hypermobile-eds"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-chronic-pain)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-chronic-pain'",
        "'best-mattress-chronic-pain', 'best-mattress-hypermobile-eds'"
    )
...
card_check = 'href="posts/best-mattress-hypermobile-eds.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-hypermobile-eds.html">Best Mattress for Hypermobile EDS (hEDS)</a></h3>\n'
    '          <p>7 picks for hEDS &mdash; nocturnal joint subluxations, proprioception deficit, POTS dysautonomia, mast cell activation &amp; hEDS sleep positioning.</p>\n'
