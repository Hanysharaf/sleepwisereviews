slug = "best-mattress-lupus-nephritis"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-sickle-cell-disease)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-sickle-cell-disease'",
        "'best-mattress-sickle-cell-disease', 'best-mattress-lupus-nephritis'"
    )
...
card_check = 'href="posts/best-mattress-lupus-nephritis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-lupus-nephritis.html">Best Mattress for Lupus Nephritis</a></h3>\n'
    '          <p>7 picks for lupus nephritis &mdash; SLE joint pain, steroid insomnia, CKD restless legs, hydroxychloroquine nightmares &amp; flare night protocol.</p>\n'
