slug = "best-mattress-stiff-person-syndrome"
...
print(f"Sitemap now has {sitemap.count('<loc>')} URLs")

with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()
if slug not in gen:
    gen = gen.replace("'best-mattress-hypermobile-eds'", "'best-mattress-hypermobile-eds', 'best-mattress-stiff-person-syndrome'")
...
with open("index.html", "r", encoding="utf-8") as f:
    html = f.read()
card_check = 'href="posts/best-mattress-stiff-person-syndrome.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'
card = ('        <div class="card-cat">\n          <span class="cat-badge" style="background:#dc2626">Health</span>\n          <h3><a href="posts/best-mattress-stiff-person-syndrome.html">Best Mattress for Stiff Person Syndrome</a></h3>\n          <p>7 picks for autoimmune muscle rigidity &mdash; stimulus-triggered spasm prevention, surface friction minimization, noise isolation &amp; safe nocturnal repositioning for extreme rigidity.</p>\n          <div class="card-meta"><span>7 picks</span><span>Health</span></div>\n        </div>\n        ')
