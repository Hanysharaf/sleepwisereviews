...
# 2. CATEGORIES -- Health Conditions (after best-mattress-hashimotos)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-hashimotos'",
        "'best-mattress-hashimotos', 'best-mattress-sjogrens-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-sjogrens-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-sjogrens-syndrome.html">Best Mattress for Sjogren\'s Syndrome</a></h3>\n'
    '          <p>7 picks for Sjogren\'s &mdash; dry eye nocturnal pain, small fiber neuropathy foot pressure, arthropathy joint zones, nocturia exits &amp; autoimmune fatigue hyperarousal.</p>\n'
