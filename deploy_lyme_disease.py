slug = "best-mattress-lyme-disease"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-pots)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-pots'",
        "'best-mattress-pots', 'best-mattress-lyme-disease'"
    )
...
card_check = 'href="posts/best-mattress-lyme-disease.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-lyme-disease.html">Best Mattress for Lyme Disease</a></h3>\n'
    '          <p>7 picks for Lyme disease &mdash; Lyme arthritis, neuroborreliosis, PTLDS fatigue, Babesia night sweats &amp; chemical sensitivity in chronic Lyme.</p>\n'
