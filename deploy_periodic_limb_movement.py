slug = "best-mattress-periodic-limb-movement"
...
# 2. CATEGORIES (after best-mattress-hyperhidrosis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-hyperhidrosis'",
        "'best-mattress-hyperhidrosis', 'best-mattress-periodic-limb-movement'"
    )
...
card_check = 'href="posts/best-mattress-periodic-limb-movement.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-periodic-limb-movement.html">Best Mattress for Periodic Limb Movement Disorder</a></h3>\n'
    '          <p>7 picks for involuntary nocturnal leg movements &mdash; motion isolation for partner protection, ankle/heel pressure relief, sleep fragmentation reduction &amp; PLMD vs. RLS distinction.</p>\n'
