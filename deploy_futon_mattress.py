...
# 2. CATEGORIES — Mattresses & Bedding (after best-full-mattress)
...
if slug not in gen:
    gen = gen.replace(
        "'best-full-mattress'",
        "'best-full-mattress', 'best-futon-mattress'"
    )
...
card_check = 'href="posts/best-futon-mattress.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Mattresses &amp; Bedding</span>\n'
    '          <h3><a href="posts/best-futon-mattress.html">Best Futon Mattress</a></h3>\n'
    '          <p>7 futon mattresses for daily use, guest rooms, and sofa beds &mdash; thickness guide, material comparison, and fold-flex ratings.</p>\n'
