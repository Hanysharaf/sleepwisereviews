...
# 2. CATEGORIES -- Health Conditions (after best-mattress-autism)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-autism'",
        "'best-mattress-autism', 'best-mattress-ibs'"
    )
...
card_check = 'href="posts/best-mattress-ibs.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-ibs.html">Best Mattress for IBS</a></h3>\n'
    '          <p>7 picks for IBS, IBD &amp; Crohn\'s sleep &mdash; nocturnal cramping, urgency-driven waking, gut-brain axis disruption &amp; position-sensitive abdominal pain.</p>\n'
