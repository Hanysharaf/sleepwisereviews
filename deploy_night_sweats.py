slug = "best-mattress-night-sweats"
...
# 2. CATEGORIES — Health Conditions (after best-mattress-topper-back-pain)
...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-topper-back-pain', 'best-mattress-night-sweats'"
    )
...
card_check = 'href="posts/best-mattress-night-sweats.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-night-sweats.html">Best Mattress for Night Sweats</a></h3>\n'
    '          <p>7 picks for menopause, hormonal, and medical night sweating &mdash; cooling technology ranked, cause-by-cause strategy table, and full sleep system guide.</p>\n'
