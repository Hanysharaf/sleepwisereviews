...
# 2. CATEGORIES (after best-mattress-charcot-marie-tooth)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-charcot-marie-tooth'",
        "'best-mattress-charcot-marie-tooth', 'best-mattress-syringomyelia'"
    )
...
card_check = 'href="posts/best-mattress-syringomyelia.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-syringomyelia.html">Best Mattress for Syringomyelia</a></h3>\n'
    '          <p>7 picks for spinal cord syrinx &mdash; CSF pressure position management, cervical-thoracic spinal alignment, pain/weakness asymmetry relief &amp; central sensitization heat control.</p>\n'
