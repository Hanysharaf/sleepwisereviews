...
# 2. CATEGORIES -- Health Conditions (after best-mattress-temporomandibular-joint-disorder)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-temporomandibular-joint-disorder'",
        "'best-mattress-temporomandibular-joint-disorder', 'best-mattress-shoulder-impingement'"
    )
...
card_check = 'href="posts/best-mattress-shoulder-impingement.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-shoulder-impingement.html">Best Mattress for Shoulder Impingement</a></h3>\n'
    '          <p>7 picks for subacromial impingement &mdash; humeral head sinkage for subacromial decompression, rotator cuff off-loading, REM arm-drift prevention, post-injection safety &amp; post-SAD surgery positioning.</p>\n'
