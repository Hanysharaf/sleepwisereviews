...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-under-200', 'best-mattress-under-300'"
    )
...
card_check = 'href="posts/best-mattress-under-200.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Budget Guide</span>\n'
    '          <h3><a href="posts/best-mattress-under-200.html">Best Mattress Under $200</a></h3>\n'
    '          <p>Top budget mattresses that deliver real sleep quality without breaking the bank. Our picks balance comfort, durability, and value.</p>\n'
    '          <div class="card-meta"><span>7 picks</span><span>Budget Guide</span></div>\n'
    '        </div>\n'
    '        '
)
