...
# 2. CATEGORIES — Sleep Positions (after best-mattress-couples)
...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-couples', 'best-mattress-couples-different-preferences'"
    )
...
card_check = 'href="posts/best-mattress-couples-different-preferences.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Sleep Positions</span>\n'
    '          <h3><a href="posts/best-mattress-couples-different-preferences.html">Best Mattress for Couples with Different Preferences</a></h3>\n'
    '          <p>7 picks when partners want different things &mdash; split king guide, dual firmness options, motion isolation ratings, and conflict-by-conflict strategy table.</p>\n'
