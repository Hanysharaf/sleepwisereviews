...
# 2. CATEGORIES (after best-mattress-pudendal-neuralgia)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-pudendal-neuralgia'",
        "'best-mattress-pudendal-neuralgia', 'best-mattress-lateral-epicondylitis'"
    )
...
card_check = 'href="posts/best-mattress-lateral-epicondylitis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-lateral-epicondylitis.html">Best Mattress for Lateral Epicondylitis (Tennis Elbow)</a></h3>\n'
    '          <p>7 picks for tennis elbow &mdash; lateral epicondyle pressure prevention, ECRB tendon load reduction in back-sleep, arm pronation stabilization during REM &amp; forearm extensor heat management.</p>\n'
