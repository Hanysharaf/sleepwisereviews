...
# 2. CATEGORIES (after best-mattress-arachnoiditis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-arachnoiditis'",
        "'best-mattress-arachnoiditis', 'best-mattress-occipital-neuralgia'"
    )
...
card_check = 'href="posts/best-mattress-occipital-neuralgia.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-occipital-neuralgia.html">Best Mattress for Occipital Neuralgia</a></h3>\n'
    '          <p>7 picks for C2/C3 nerve compression at the skull base &mdash; pillow-neck interface pressure relief, cervical neutral alignment, temple contact prevention &amp; REM hyperflexion avoidance.</p>\n'
