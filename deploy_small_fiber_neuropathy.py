...
# 2. CATEGORIES (after best-mattress-tarsal-tunnel-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-tarsal-tunnel-syndrome'",
        "'best-mattress-tarsal-tunnel-syndrome', 'best-mattress-small-fiber-neuropathy'"
    )
...
card_check = 'href="posts/best-mattress-small-fiber-neuropathy.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-small-fiber-neuropathy.html">Best Mattress for Small Fiber Neuropathy</a></h3>\n'
    '          <p>7 picks for A-delta/C fiber degeneration &mdash; allodynia pressure management, MCAS co-morbidity support, IENFD-guided surface selection &amp; temperature dysregulation relief.</p>\n'
