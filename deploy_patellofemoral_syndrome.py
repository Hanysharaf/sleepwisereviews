...
# 2. CATEGORIES (after best-mattress-achilles-tendinopathy)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-achilles-tendinopathy'",
        "'best-mattress-achilles-tendinopathy', 'best-mattress-patellofemoral-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-patellofemoral-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-patellofemoral-syndrome.html">Best Mattress for Patellofemoral Syndrome</a></h3>\n'
    '          <p>7 picks for runner\'s knee &mdash; lateral patellar tilt prevention, 10-20 deg elevation near-zero patellofemoral contact, IT band tension reduction in side-sleep &amp; hip adduction collapse management.</p>\n'
