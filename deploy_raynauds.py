...
# 2. CATEGORIES -- Health Conditions (after best-mattress-dysautonomia)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-dysautonomia'",
        "'best-mattress-dysautonomia', 'best-mattress-raynauds'"
    )
...
card_check = 'href="posts/best-mattress-raynauds.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-raynauds.html">Best Mattress for Raynaud\'s Disease</a></h3>\n'
    '          <p>7 picks for Raynaud\'s &mdash; cold vasospasm prevention, scleroderma digital ulcer pressure relief, lupus overlap, couples temperature mismatch &amp; nighttime attack management.</p>\n'
