...
# 2. CATEGORIES (after best-mattress-intracranial-hypertension)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-intracranial-hypertension'",
        "'best-mattress-intracranial-hypertension', 'best-mattress-arachnoiditis'"
    )
...
card_check = 'href="posts/best-mattress-arachnoiditis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-arachnoiditis.html">Best Mattress for Arachnoiditis</a></h3>\n'
    '          <p>7 picks for spinal arachnoid inflammation &mdash; CSF pressure redistribution, cauda equina nerve root offloading, position-change pain minimization &amp; arachnoid adhesion management during sleep.</p>\n'
