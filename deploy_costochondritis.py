...
# 2. CATEGORIES -- Health Conditions (after best-mattress-sacroiliac-joint-pain)
...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-sacroiliac-joint-pain', 'best-mattress-costochondritis'"
    )
...
card_check = 'href="posts/best-mattress-costochondritis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-costochondritis.html">Best Mattress for Costochondritis</a></h3>\n'
    '          <p>7 picks for costochondritis &mdash; lateral rib pressure relief, back-sleep thoracic support, post-COVID bilateral inflammation, anxiety hyperarousal &amp; fibromyalgia overlap.</p>\n'
