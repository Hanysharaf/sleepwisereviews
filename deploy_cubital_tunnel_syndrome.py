...
# 2. CATEGORIES (after best-mattress-patellofemoral-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-patellofemoral-syndrome'",
        "'best-mattress-patellofemoral-syndrome', 'best-mattress-cubital-tunnel-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-cubital-tunnel-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-cubital-tunnel-syndrome.html">Best Mattress for Cubital Tunnel Syndrome</a></h3>\n'
    '          <p>7 picks for ulnar nerve entrapment &mdash; medial epicondyle pressure prevention, elbow-extension sleep arm stabilization, REM unconscious flexion control &amp; double crush syndrome management.</p>\n'
