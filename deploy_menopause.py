...
# 2. CATEGORIES — Health Conditions (after best-mattress-night-sweats)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-night-sweats'",
        "'best-mattress-night-sweats', 'best-mattress-menopause'"
    )
...
card_check = 'href="posts/best-mattress-menopause.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-menopause.html">Best Mattress for Menopause</a></h3>\n'
    '          <p>7 picks for the full menopause sleep cluster &mdash; hot flashes, joint pain, insomnia, and restless sleep all addressed with symptom-by-symptom strategy table.</p>\n'
