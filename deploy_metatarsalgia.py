slug = "best-mattress-metatarsalgia"
...
# 2. CATEGORIES (after best-mattress-occipital-neuralgia)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-occipital-neuralgia'",
        "'best-mattress-occipital-neuralgia', 'best-mattress-metatarsalgia'"
    )
...
card_check = 'href="posts/best-mattress-metatarsalgia.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-metatarsalgia.html">Best Mattress for Metatarsalgia</a></h3>\n'
    '          <p>7 picks for forefoot inflammation &mdash; bedding-weight toe splay prevention, transverse arch support, ankle-neutral positioning &amp; nocturnal repositioning load reduction.</p>\n'
