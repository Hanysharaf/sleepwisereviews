...
# 2. CATEGORIES — Life Stages (after best-mattress-tall-person)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-tall-person'",
        "'best-mattress-tall-person', 'best-mattress-teenager'"
    )
...
card_check = 'href="posts/best-mattress-teenager.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-teenager.html">Best Mattress for Teenagers</a></h3>\n'
    '          <p>7 picks for growing bodies, bunk beds &amp; tight budgets &mdash; spinal development guide, bunk bed thickness safety table, twin vs full size decision, and picks for every price point.</p>\n'
