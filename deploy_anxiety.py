...
# 2. CATEGORIES -- Health Conditions (after best-mattress-copd)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-copd'",
        "'best-mattress-copd', 'best-mattress-anxiety'"
    )
...
card_check = 'href="posts/best-mattress-anxiety.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-anxiety.html">Best Mattress for Anxiety</a></h3>\n'
    '          <p>7 picks for anxiety-driven sleep problems &mdash; pressure relief for somatic tension, motion isolation for hyperarousal, cortisol cooling &amp; the anxiety-insomnia cycle explained.</p>\n'
