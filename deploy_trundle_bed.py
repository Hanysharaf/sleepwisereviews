...
# 2. CATEGORIES — Life Stages (after best-mattress-daybed)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-daybed'",
        "'best-mattress-daybed', 'best-mattress-trundle-bed'"
    )
...
card_check = 'href="posts/best-mattress-trundle-bed.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-trundle-bed.html">Best Mattress for Trundle Beds</a></h3>\n'
    '          <p>7 thin-profile picks with clearance measurement guide &mdash; pop-up vs flat trundle requirements, max thickness by frame type, and foam vs spring for tight spaces.</p>\n'
