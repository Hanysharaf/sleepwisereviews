...
if slug not in gen:
    # Insert in Mattresses & Bedding after best-twin-mattress
    gen = gen.replace(
        "'best-twin-mattress'",
        "'best-twin-mattress', 'best-queen-mattress'"
    )
...
card_check = 'href="posts/best-queen-mattress.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Mattresses &amp; Bedding</span>\n'
    '          <h3><a href="posts/best-queen-mattress.html">Best Queen Mattress</a></h3>\n'
    '          <p>The most popular mattress size — 7 top queen picks tested across every sleeper type, budget range, and use case.</p>\n'
