slug = "best-mattress-thoracic-outlet-syndrome"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-scleroderma)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-scleroderma'",
        "'best-mattress-scleroderma', 'best-mattress-thoracic-outlet-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-thoracic-outlet-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-thoracic-outlet-syndrome.html">Best Mattress for Thoracic Outlet Syndrome</a></h3>\n'
    '          <p>7 picks for TOS &mdash; shoulder zone decompression, arm-overhead position prevention, brachial plexus sleep relief, scalene tension reduction &amp; venous/neurogenic TOS positioning.</p>\n'
