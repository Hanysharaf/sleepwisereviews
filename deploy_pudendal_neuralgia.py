...
# 2. CATEGORIES (after best-mattress-trigeminal-neuralgia)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-trigeminal-neuralgia'",
        "'best-mattress-trigeminal-neuralgia', 'best-mattress-pudendal-neuralgia'"
    )
...
card_check = 'href="posts/best-mattress-pudendal-neuralgia.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-pudendal-neuralgia.html">Best Mattress for Pudendal Neuralgia</a></h3>\n'
    '          <p>7 picks for pudendal nerve entrapment &mdash; ischial tuberosity pressure elimination, Alcock\'s canal decompression in side-sleep, hip elevation offloading &amp; prone position contraindication management.</p>\n'
