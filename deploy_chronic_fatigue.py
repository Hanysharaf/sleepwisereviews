...
# 2. CATEGORIES — Health Conditions (after best-mattress-neuropathy)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-neuropathy'",
        "'best-mattress-neuropathy', 'best-mattress-chronic-fatigue'"
    )
...
card_check = 'href="posts/best-mattress-chronic-fatigue.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-chronic-fatigue.html">Best Mattress for Chronic Fatigue Syndrome</a></h3>\n'
    '          <p>7 picks for CFS and ME with post-exertional malaise guide &mdash; pressure relief for extended bed rest, edge support for POTS transitions, and the symptom cluster vs priority table.</p>\n'
