slug = "best-mattress-multiple-chemical-sensitivity"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-stroke-recovery)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-stroke-recovery'",
        "'best-mattress-stroke-recovery', 'best-mattress-multiple-chemical-sensitivity'"
    )
...
card_check = 'href="posts/best-mattress-multiple-chemical-sensitivity.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-multiple-chemical-sensitivity.html">Best Mattress for Multiple Chemical Sensitivity</a></h3>\n'
    '          <p>7 VOC-free picks for MCS &mdash; natural latex, organic wool &amp; cotton, GOLS/GOTS certified, zero synthetic foam &amp; chemical flame retardants.</p>\n'
