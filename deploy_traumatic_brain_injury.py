slug = "best-mattress-traumatic-brain-injury"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-alzheimers-dementia)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-alzheimers-dementia'",
        "'best-mattress-alzheimers-dementia', 'best-mattress-traumatic-brain-injury'"
    )
...
card_check = 'href="posts/best-mattress-traumatic-brain-injury.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-traumatic-brain-injury.html">Best Mattress for Traumatic Brain Injury (TBI)</a></h3>\n'
    '          <p>7 picks for TBI &mdash; post-traumatic hypersomnia, headache prevention, phonophobia, ICP elevation &amp; partner motion isolation for recovery sleep.</p>\n'
