slug = "best-mattress-tourette-syndrome"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-osteoporosis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-osteoporosis'",
        "'best-mattress-osteoporosis', 'best-mattress-tourette-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-tourette-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-tourette-syndrome.html">Best Mattress for Tourette Syndrome</a></h3>\n'
    '          <p>7 picks for Tourette syndrome &mdash; tic motion isolation, comorbid ADHD delayed sleep phase, OCD pre-sleep anxiety, sensory sensitivity &amp; medication titration periods.</p>\n'
