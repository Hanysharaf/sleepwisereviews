...
# 2. CATEGORIES -- Health Conditions (after best-mattress-marfan-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-marfan-syndrome'",
        "'best-mattress-marfan-syndrome', 'best-mattress-osteogenesis-imperfecta'"
    )
...
card_check = 'href="posts/best-mattress-osteogenesis-imperfecta.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-osteogenesis-imperfecta.html">Best Mattress for Osteogenesis Imperfecta</a></h3>\n'
    '          <p>7 picks for brittle bone disease &mdash; sub-32mmHg fracture-risk pressure distribution, motorized safe repositioning, OI scoliosis zones, partner force isolation &amp; bisphosphonate treatment trajectory.</p>\n'
