...
# 2. CATEGORIES — Life Stages (after best-mattress-studio-apartment)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-studio-apartment'",
        "'best-mattress-studio-apartment', 'best-mattress-bunk-beds'"
    )
...
card_check = 'href="posts/best-mattress-bunk-beds.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-bunk-beds.html">Best Mattress for Bunk Beds</a></h3>\n'
    '          <p>7 picks with CPSC safety guide &mdash; top bunk thickness limits, guardrail clearance rules, and age-based recommendations for kids, teens, and dorms.</p>\n'
