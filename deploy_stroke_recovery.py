slug = "best-mattress-stroke-recovery"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-hiv-aids)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-hiv-aids'",
        "'best-mattress-hiv-aids', 'best-mattress-stroke-recovery'"
    )
...
card_check = 'href="posts/best-mattress-stroke-recovery.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-stroke-recovery.html">Best Mattress for Stroke Recovery</a></h3>\n'
    '          <p>7 picks for stroke recovery &mdash; hemiplegia, spasticity, pressure injury prevention, caregiver-assisted turning &amp; post-stroke insomnia.</p>\n'
