slug = "best-mattress-interstitial-cystitis"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-ibs)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-ibs'",
        "'best-mattress-ibs', 'best-mattress-interstitial-cystitis'"
    )
...
card_check = 'href="posts/best-mattress-interstitial-cystitis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-interstitial-cystitis.html">Best Mattress for Interstitial Cystitis</a></h3>\n'
    '          <p>7 picks for IC &amp; bladder pain syndrome &mdash; nocturia-driven waking, pelvic floor pressure relief, position-sensitive bladder pain &amp; quick-exit urgency design.</p>\n'
