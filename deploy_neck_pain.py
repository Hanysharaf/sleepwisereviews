...
if slug not in gen:
    # Insert in Health Conditions after best-mattress-scoliosis
    gen = gen.replace(
        "'best-mattress-scoliosis'",
        "'best-mattress-scoliosis', 'best-mattress-neck-pain'"
    )
...
card_check = 'href="posts/best-mattress-neck-pain.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-neck-pain.html">Best Mattress for Neck Pain</a></h3>\n'
    '          <p>7 mattresses that keep your cervical spine aligned &mdash; with pillow pairing guides by sleep position and warning signs your mattress is the cause.</p>\n'
