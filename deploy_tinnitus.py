...
# 2. CATEGORIES -- Health Conditions (after best-mattress-celiac-disease)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-celiac-disease'",
        "'best-mattress-celiac-disease', 'best-mattress-tinnitus'"
    )
...
card_check = 'href="posts/best-mattress-tinnitus.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-tinnitus.html">Best Mattress for Tinnitus</a></h3>\n'
    '          <p>7 picks for tinnitus &mdash; Meniere\'s ear positioning, TMJ jaw tension, pulsatile vascular management, hyperacusis partner sensitivity &amp; tinnitus-insomnia cycle.</p>\n'
