...
# 2. CATEGORIES — Life Stages (after best-mattress-overheating-pregnancy)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-overheating-pregnancy'",
        "'best-mattress-overheating-pregnancy', 'best-mattress-tall-person'"
    )
...
card_check = 'href="posts/best-mattress-tall-person.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-tall-person.html">Best Mattress for Tall People</a></h3>\n'
    '          <p>7 picks for 6\'2"+ sleepers with length calculation guide &mdash; California King vs King comparison, height-to-size chart, and firmness recommendations by sleep position.</p>\n'
    '          <div class="card-meta"><span>7 picks</span><span>Life Stages</span></div>\n'
    '        </div>\n'
    '        '
)
