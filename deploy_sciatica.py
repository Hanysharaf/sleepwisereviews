...
# 2. CATEGORIES -- Health Conditions (after best-mattress-parkinsons)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-parkinsons'",
        "'best-mattress-parkinsons', 'best-mattress-sciatica'"
    )
...
card_check = 'href="posts/best-mattress-sciatica.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-sciatica.html">Best Mattress for Sciatica</a></h3>\n'
    '          <p>7 picks for L4-L5-S1 nerve compression &amp; piriformis syndrome &mdash; spinal decompression positioning, hip pressure relief, disc vs piriformis sciatica guide.</p>\n'
