slug = "best-mattress-cerebral-palsy"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-huntingtons-disease)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-huntingtons-disease'",
        "'best-mattress-huntingtons-disease', 'best-mattress-cerebral-palsy'"
    )
...
card_check = 'href="posts/best-mattress-cerebral-palsy.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-cerebral-palsy.html">Best Mattress for Cerebral Palsy</a></h3>\n'
    '          <p>7 picks for CP &mdash; spasticity &amp; dystonia positioning, GERD elevation, scoliosis pressure relief, seizure safety &amp; caregiver repositioning access.</p>\n'
