slug = "best-mattress-degenerative-disc"
...
# 2. CATEGORIES — Health Conditions (after best-mattress-spinal-stenosis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-spinal-stenosis'",
        "'best-mattress-spinal-stenosis', 'best-mattress-degenerative-disc'"
    )
...
card_check = 'href="posts/best-mattress-degenerative-disc.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-degenerative-disc.html">Best Mattress for Degenerative Disc Disease</a></h3>\n'
    '          <p>7 mattresses to reduce DDD pain at night &mdash; Lancet-backed firmness guidance, sleep position protocol, and disc severity guide.</p>\n'
