...
if slug not in gen:
    # Insert in Health Conditions after best-mattress-chronic-back-pain
    gen = gen.replace(
        "'best-mattress-chronic-back-pain'",
        "'best-mattress-chronic-back-pain', 'best-mattress-hot-sleepers'"
    )
...
card_check = 'href="posts/best-mattress-hot-sleepers.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-hot-sleepers.html">Best Mattress for Hot Sleepers</a></h3>\n'
    '          <p>Cooling mattresses that actually work — tested on real temperature performance, not just marketing claims. Grid, latex, hybrid, and copper-infused picks.</p>\n'
