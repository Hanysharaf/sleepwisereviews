slug = "best-mattress-spinal-stenosis-cervical"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-ehlers-danlos-classical)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-ehlers-danlos-classical'",
        "'best-mattress-ehlers-danlos-classical', 'best-mattress-spinal-stenosis-cervical'"
    )
...
card_check = 'href="posts/best-mattress-spinal-stenosis-cervical.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-spinal-stenosis-cervical.html">Best Mattress for Cervical Spinal Stenosis</a></h3>\n'
    '          <p>7 picks for cervical stenosis &mdash; motorized canal positioning, arm symptom shoulder zones, myelopathy neutral alignment, partner motion isolation &amp; post-fusion recovery.</p>\n'
