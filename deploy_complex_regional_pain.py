...
# 2. CATEGORIES -- Health Conditions (after best-mattress-peripheral-artery-disease)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-peripheral-artery-disease'",
        "'best-mattress-peripheral-artery-disease', 'best-mattress-complex-regional-pain'"
    )
...
card_check = 'href="posts/best-mattress-complex-regional-pain.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-complex-regional-pain.html">Best Mattress for CRPS</a></h3>\n'
    '          <p>7 picks for complex regional pain syndrome &mdash; allodynia contact sensitivity, sympathetically-maintained pain, temperature dysregulation, SCS treatment compatibility &amp; MCAS overlap.</p>\n'
