...
# 2. CATEGORIES -- Health Conditions (after best-mattress-frozen-shoulder)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-frozen-shoulder'",
        "'best-mattress-frozen-shoulder', 'best-mattress-carpal-tunnel-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-carpal-tunnel-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-carpal-tunnel-syndrome.html">Best Mattress for Carpal Tunnel Syndrome</a></h3>\n'
    '          <p>7 picks for CTS &mdash; neutral wrist positioning during sleep, shoulder alignment preventing median nerve tension, back-sleep elevation for thoracic outlet, REM-stable contouring &amp; 365-night post-surgical trial.</p>\n'
