...
# 2. CATEGORIES -- Health Conditions (after best-mattress-anxiety)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-anxiety'",
        "'best-mattress-anxiety', 'best-mattress-pcos'"
    )
...
card_check = 'href="posts/best-mattress-pcos.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-pcos.html">Best Mattress for PCOS</a></h3>\n'
    '          <p>7 picks for PCOS hormonal sleep disruption &mdash; 3x sleep apnea risk, androgen-driven night sweats, insulin resistance sleep link &amp; the bidirectional PCOS-sleep cycle explained.</p>\n'
