slug = "best-mattress-sleep-apnea"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-muscular-dystrophy)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-muscular-dystrophy'",
        "'best-mattress-muscular-dystrophy', 'best-mattress-sleep-apnea'"
    )
...
card_check = 'href="posts/best-mattress-sleep-apnea.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-sleep-apnea.html">Best Mattress for Sleep Apnea</a></h3>\n'
    '          <p>7 picks for OSA &mdash; CPAP lateral positioning, positional therapy, head elevation, partner disruption isolation &amp; weight-related sleep apnea guide.</p>\n'
