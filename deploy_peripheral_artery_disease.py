slug = "best-mattress-peripheral-artery-disease"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-bursitis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-bursitis'",
        "'best-mattress-bursitis', 'best-mattress-peripheral-artery-disease'"
    )
...
card_check = 'href="posts/best-mattress-peripheral-artery-disease.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-peripheral-artery-disease.html">Best Mattress for Peripheral Artery Disease</a></h3>\n'
    '          <p>7 picks for PAD &mdash; sub-32 mmHg heel pressure, position-dependent rest pain relief, diabetic PAD skin protection, RLS accommodation &amp; adjustable base dependent positioning.</p>\n'
