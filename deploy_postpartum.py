...
# 2. CATEGORIES -- Life Stages (after best-mattress-newlyweds)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-newlyweds'",
        "'best-mattress-newlyweds', 'best-mattress-postpartum'"
    )
...
card_check = 'href="posts/best-mattress-postpartum.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge" style="background:#7c3aed">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-postpartum.html">Best Mattress for Postpartum Recovery</a></h3>\n'
    '          <p>7 picks for new mothers &mdash; C-section log-roll exit, breastfeeding side position, hormonal night sweats &amp; protecting your partner through 12 weeks of feeds.</p>\n'
