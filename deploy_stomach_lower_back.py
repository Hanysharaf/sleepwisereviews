slug = "best-mattress-stomach-sleepers-lower-back-pain"
...
if slug not in gen:
    # Insert in Health Conditions after best-mattress-stomach-sleepers-back-pain
    gen = gen.replace(
        "'best-mattress-stomach-sleepers-back-pain'",
        "'best-mattress-stomach-sleepers-back-pain', 'best-mattress-stomach-sleepers-lower-back-pain'"
    )
...
card_check = 'href="posts/best-mattress-stomach-sleepers-lower-back-pain.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-stomach-sleepers-lower-back-pain.html">Best Mattress for Stomach Sleepers with Lower Back Pain</a></h3>\n'
    '          <p>7 firm mattresses that prevent the hip sinkage causing stomach sleepers morning back pain &mdash; firmness guide by weight, warning signs checklist, pillow tips.</p>\n'
