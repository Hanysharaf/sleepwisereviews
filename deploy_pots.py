...
# 2. CATEGORIES -- Health Conditions (after best-mattress-hypermobile-eds)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-hypermobile-eds'",
        "'best-mattress-hypermobile-eds', 'best-mattress-pots'"
    )
...
card_check = 'href="posts/best-mattress-pots.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-pots.html">Best Mattress for POTS</a></h3>\n'
    '          <p>7 picks for POTS &mdash; safe bed exit, subtype-specific elevation, hyperadrenergic insomnia, heat intolerance &amp; dysautonomia sleep positioning.</p>\n'
