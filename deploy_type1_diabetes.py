slug = "best-mattress-type1-diabetes"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-psoriatic-arthritis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-psoriatic-arthritis'",
        "'best-mattress-psoriatic-arthritis', 'best-mattress-type1-diabetes'"
    )
...
card_check = 'href="posts/best-mattress-type1-diabetes.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-type1-diabetes.html">Best Mattress for Type 1 Diabetes</a></h3>\n'
    '          <p>7 picks for T1D &mdash; CGM sensor pressure, nocturnal hypoglycemia alerts, neuropathy allodynia, insulin pump positioning &amp; night sweat management.</p>\n'
