...
# 2. CATEGORIES -- Health Conditions (after best-mattress-crohns-disease)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-crohns-disease'",
        "'best-mattress-crohns-disease', 'best-mattress-osteoporosis'"
    )
...
card_check = 'href="posts/best-mattress-osteoporosis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-osteoporosis.html">Best Mattress for Osteoporosis</a></h3>\n'
    '          <p>7 picks for osteoporosis &mdash; vertebral compression fracture pain, kyphosis support, hip fracture recovery, fall prevention &amp; corticosteroid-induced insomnia.</p>\n'
