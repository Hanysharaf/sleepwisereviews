...
# 2. CATEGORIES — Health Conditions (after best-mattress-stomach-sleepers-lower-back-pain)
...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-stomach-sleepers-lower-back-pain', 'best-mattress-neuropathy'"
    )
...
card_check = 'href="posts/best-mattress-neuropathy.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-neuropathy.html">Best Mattress for Neuropathy</a></h3>\n'
    '          <p>7 picks for peripheral and diabetic nerve pain &mdash; pressure relief science, why firm mattresses worsen symptoms, neuropathy type vs priority guide, and sleep position recommendations.</p>\n'
