...
# 2. CATEGORIES -- Health Conditions (after best-mattress-avascular-necrosis-hip)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-avascular-necrosis-hip'",
        "'best-mattress-avascular-necrosis-hip', 'best-mattress-temporomandibular-joint-disorder'"
    )
...
card_check = 'href="posts/best-mattress-temporomandibular-joint-disorder.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-temporomandibular-joint-disorder.html">Best Mattress for TMJ Disorder</a></h3>\n'
    '          <p>7 picks for TMD/TMJ &mdash; jaw-cervical alignment, side-sleep condylar compression reduction, bruxism surface stability, masseter tension relief &amp; back-sleep nocturnal disc decompression.</p>\n'
