slug = "best-mattress-alzheimers-dementia"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-spinal-cord-injury)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-spinal-cord-injury'",
        "'best-mattress-spinal-cord-injury', 'best-mattress-alzheimers-dementia'"
    )
...
card_check = 'href="posts/best-mattress-alzheimers-dementia.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-alzheimers-dementia.html">Best Mattress for Alzheimer\'s &amp; Dementia</a></h3>\n'
    '          <p>7 picks for dementia &mdash; sundowning, sleep-wake reversal, REM behavior disorder, wandering safety &amp; caregiver sleep protection.</p>\n'
