slug = "best-mattress-chronic-hives"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-tinnitus)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-tinnitus'",
        "'best-mattress-tinnitus', 'best-mattress-chronic-hives'"
    )
...
card_check = 'href="posts/best-mattress-chronic-hives.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-chronic-hives.html">Best Mattress for Chronic Hives</a></h3>\n'
    '          <p>7 picks for chronic urticaria &mdash; pressure urticaria, dermatographia surface, cholinergic heat triggers, contact sensitivity &amp; antihistamine-managed sleep.</p>\n'
