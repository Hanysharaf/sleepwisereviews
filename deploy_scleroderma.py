...
# 2. CATEGORIES -- Health Conditions (after best-mattress-osteogenesis-imperfecta)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-osteogenesis-imperfecta'",
        "'best-mattress-osteogenesis-imperfecta', 'best-mattress-scleroderma'"
    )
...
card_check = 'href="posts/best-mattress-scleroderma.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-scleroderma.html">Best Mattress for Scleroderma</a></h3>\n'
    '          <p>7 picks for systemic sclerosis &mdash; Raynaud\'s temperature neutrality, esophageal GERD elevation, calcinosis pressure relief, joint contracture contouring &amp; ILD breathlessness positioning.</p>\n'
