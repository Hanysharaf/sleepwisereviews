...
# 2. CATEGORIES (after best-mattress-central-sensitization)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-central-sensitization'",
        "'best-mattress-central-sensitization', 'best-mattress-lipedema'"
    )
...
card_check = 'href="posts/best-mattress-lipedema.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-lipedema.html">Best Mattress for Lipedema</a></h3>\n'
    '          <p>7 picks for bilateral fat tissue disorder &mdash; side-sleeping leg compression prevention, foam sinkage and tender tissue mechanics, overnight elevation &amp; heat reduction around legs.</p>\n'
