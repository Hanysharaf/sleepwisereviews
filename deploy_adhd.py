...
# 2. CATEGORIES -- Health Conditions (after best-mattress-ptsd)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-ptsd'",
        "'best-mattress-ptsd', 'best-mattress-adhd'"
    )
...
card_check = 'href="posts/best-mattress-adhd.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-adhd.html">Best Mattress for ADHD</a></h3>\n'
    '          <p>7 picks for ADHD sleep &mdash; delayed sleep phase, sensory hypersensitivity, stimulant medication effects, executive dysfunction barriers &amp; comorbid restless legs/OSA.</p>\n'
