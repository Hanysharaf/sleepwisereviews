slug = "best-mattress-psoriatic-arthritis"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-traumatic-brain-injury)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-traumatic-brain-injury'",
        "'best-mattress-traumatic-brain-injury', 'best-mattress-psoriatic-arthritis'"
    )
...
card_check = 'href="posts/best-mattress-psoriatic-arthritis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-psoriatic-arthritis.html">Best Mattress for Psoriatic Arthritis</a></h3>\n'
    '          <p>7 picks for PsA &mdash; joint and skin pressure relief, temperature flare triggers, biologics night sweats, dactylitis positioning &amp; axial stiffness.</p>\n'
