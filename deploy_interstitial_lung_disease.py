...
# 2. CATEGORIES -- Health Conditions (after best-mattress-costochondritis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-costochondritis'",
        "'best-mattress-costochondritis', 'best-mattress-interstitial-lung-disease'"
    )
...
card_check = 'href="posts/best-mattress-interstitial-lung-disease.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-interstitial-lung-disease.html">Best Mattress for Interstitial Lung Disease</a></h3>\n'
    '          <p>7 picks for ILD &mdash; 30-45 degree nocturnal elevation, sacral pressure relief during extended positioning, dyspnea anxiety calming, hypersensitivity pneumonitis VOC-free &amp; antifibrotic recovery.</p>\n'
