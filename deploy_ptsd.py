...
# 2. CATEGORIES -- Health Conditions (after best-mattress-long-covid)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-long-covid'",
        "'best-mattress-long-covid', 'best-mattress-ptsd'"
    )
...
card_check = 'href="posts/best-mattress-ptsd.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-ptsd.html">Best Mattress for PTSD</a></h3>\n'
    '          <p>7 picks for PTSD sleep &mdash; hypervigilance management, nightmare fragmentation, sensitized startle response &amp; trauma-informed sleep environment design.</p>\n'
