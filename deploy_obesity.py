...
# 2. CATEGORIES -- Health Conditions (after best-mattress-heart-failure)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-heart-failure'",
        "'best-mattress-heart-failure', 'best-mattress-obesity'"
    )
...
card_check = 'href="posts/best-mattress-obesity.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-obesity.html">Best Mattress for Obesity</a></h3>\n'
    '          <p>7 picks for high BMI sleep &mdash; durable support at 300-500+ lbs, pressure distribution, heat management, edge longevity &amp; sleep apnea positioning.</p>\n'
