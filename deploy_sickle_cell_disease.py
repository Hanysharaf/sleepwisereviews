slug = "best-mattress-sickle-cell-disease"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-type1-diabetes)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-type1-diabetes'",
        "'best-mattress-type1-diabetes', 'best-mattress-sickle-cell-disease'"
    )
...
card_check = 'href="posts/best-mattress-sickle-cell-disease.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-sickle-cell-disease.html">Best Mattress for Sickle Cell Disease</a></h3>\n'
    '          <p>7 picks for SCD &mdash; vaso-occlusive crisis pain, hip and shoulder AVN, cold-triggered sickling, functional asplenia &amp; chronic anemia fatigue.</p>\n'
