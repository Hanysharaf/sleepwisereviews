...
# 2. CATEGORIES -- Health Conditions (after best-mattress-depression)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-depression'",
        "'best-mattress-depression', 'best-mattress-heart-failure'"
    )
...
card_check = 'href="posts/best-mattress-heart-failure.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-heart-failure.html">Best Mattress for Heart Failure</a></h3>\n'
    '          <p>7 picks for heart failure sleep &mdash; orthopnea elevation, paroxysmal nocturnal dyspnea, cardiac night sweats, diuretic nocturia &amp; Cheyne-Stokes breathing management.</p>\n'
