...
# 2. CATEGORIES — Life Stages (after best-mattress-trundle-bed)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-trundle-bed'",
        "'best-mattress-trundle-bed', 'best-mattress-overheating-pregnancy'"
    )
...
card_check = 'href="posts/best-mattress-overheating-pregnancy.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-overheating-pregnancy.html">Best Mattress for Overheating During Pregnancy</a></h3>\n'
    '          <p>7 cooling picks with trimester-by-trimester guide &mdash; hormone-driven heat science, left-side sleeping requirements, and hybrid vs foam cooling comparison.</p>\n'
