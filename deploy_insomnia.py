...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-acid-reflux', 'best-mattress-insomnia'"
    )
...
card_check = 'href="posts/best-mattress-insomnia.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-insomnia.html">Best Mattress for Insomnia</a></h3>\n'
    '          <p>7 mattresses that remove the physical barriers to sleep onset &mdash; heat, pressure points, and partner motion. Includes CBT-I protocol alignment and sleep hygiene checklist.</p>\n'
