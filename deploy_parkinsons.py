...
# 2. CATEGORIES -- Health Conditions (after best-mattress-restless-legs)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-restless-legs'",
        "'best-mattress-restless-legs', 'best-mattress-parkinsons'"
    )
...
card_check = 'href="posts/best-mattress-parkinsons.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-parkinsons.html">Best Mattress for Parkinson\'s Disease</a></h3>\n'
    '          <p>7 picks for PD rigidity, REM behavior disorder &amp; safe nighttime exit &mdash; responsive coils for turning assist, impact absorption for RBD, caregiver access guide.</p>\n'
