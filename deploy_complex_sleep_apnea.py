...
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()
if slug not in gen:
    gen = gen.replace("'best-mattress-stiff-person-syndrome'", "'best-mattress-stiff-person-syndrome', 'best-mattress-complex-sleep-apnea'")
...
with open("index.html", "r", encoding="utf-8") as f:
    html = f.read()
card_check = 'href="posts/best-mattress-complex-sleep-apnea.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'
card = ('        <div class="card-cat">\n          <span class="cat-badge" style="background:#dc2626">Health</span>\n          <h3><a href="posts/best-mattress-complex-sleep-apnea.html">Best Mattress for Complex Sleep Apnea</a></h3>\n          <p>7 picks for treatment-emergent central apnea &mdash; PAP therapy hose management, head elevation for airway patency, positional lateral therapy &amp; mask seal stability.</p>\n          <div class="card-meta"><span>7 picks</span><span>Health</span></div>\n        </div>\n        ')
