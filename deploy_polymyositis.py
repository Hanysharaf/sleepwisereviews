slug = "best-mattress-polymyositis"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-carpal-tunnel-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-carpal-tunnel-syndrome'",
        "'best-mattress-carpal-tunnel-syndrome', 'best-mattress-polymyositis'"
    )
...
card_check = 'href="posts/best-mattress-polymyositis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-polymyositis.html">Best Mattress for Polymyositis</a></h3>\n'
    '          <p>7 picks for inflammatory myopathy &mdash; proximal muscle weakness passive repositioning, sub-32mmHg pressure at all prominences, ILD respiratory elevation, immunosuppression-safe materials &amp; CK flare management.</p>\n'
