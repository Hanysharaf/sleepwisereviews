...
# 2. CATEGORIES (after best-mattress-de-quervain-tenosynovitis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-de-quervain-tenosynovitis'",
        "'best-mattress-de-quervain-tenosynovitis', 'best-mattress-tarsal-tunnel-syndrome'"
    )
...
card_check = 'href="posts/best-mattress-tarsal-tunnel-syndrome.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-tarsal-tunnel-syndrome.html">Best Mattress for Tarsal Tunnel Syndrome</a></h3>\n'
    '          <p>7 picks for posterior tibial nerve entrapment &mdash; medial ankle pressure prevention, ankle pronation/eversion control, leg elevation for tunnel edema &amp; distinction from plantar fasciitis.</p>\n'
