...
# 2. CATEGORIES -- Health Conditions (after best-mattress-complex-regional-pain)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-complex-regional-pain'",
        "'best-mattress-complex-regional-pain', 'best-mattress-sacroiliac-joint-pain'"
    )
...
card_check = 'href="posts/best-mattress-sacroiliac-joint-pain.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-sacroiliac-joint-pain.html">Best Mattress for Sacroiliac Joint Pain</a></h3>\n'
    '          <p>7 picks for SI joint pain &mdash; lumbosacral zone support, sacral pressure distribution, pregnancy relaxin hypermobility, sacroiliitis inflammation &amp; pelvic neutrality.</p>\n'
