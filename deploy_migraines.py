...
# 2. CATEGORIES -- Health Conditions (after best-mattress-sciatica)
...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-sciatica', 'best-mattress-migraines'"
    )
...
card_check = 'href="posts/best-mattress-migraines.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-migraines.html">Best Mattress for Migraines</a></h3>\n'
    '          <p>7 picks for migraineurs &mdash; cervical alignment to reduce cervicogenic triggers, temperature control, motion isolation during attacks, and zero-VOC options for the chemically sensitive.</p>\n'
