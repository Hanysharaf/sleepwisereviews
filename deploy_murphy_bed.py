...
# 2. CATEGORIES — Life Stages (after best-mattress-rv)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-rv'",
        "'best-mattress-rv', 'best-mattress-murphy-bed'"
    )
...
card_check = 'href="posts/best-mattress-murphy-bed.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-murphy-bed.html">Best Mattress for Murphy Beds</a></h3>\n'
    '          <p>7 picks with thickness limits by frame brand &mdash; vertical storage performance table, fold-cycle durability guide, and daily vs occasional use recommendations.</p>\n'
