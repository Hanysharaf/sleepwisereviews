...
# 2. CATEGORIES -- Health Conditions (after best-mattress-polymyalgia-rheumatica)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-polymyalgia-rheumatica'",
        "'best-mattress-polymyalgia-rheumatica', 'best-mattress-bursitis'"
    )
...
card_check = 'href="posts/best-mattress-bursitis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-bursitis.html">Best Mattress for Bursitis</a></h3>\n'
    '          <p>7 picks for bursitis &mdash; sub-32 mmHg subacromial and trochanteric bursa pressure, side-sleep positioning, prepatellar knee relief &amp; reactive autoimmune bursitis.</p>\n'
