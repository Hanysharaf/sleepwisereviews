slug = "best-mattress-topper-back-pain"
...
# 2. CATEGORIES — Health Conditions (after best-mattress-degenerative-disc)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-degenerative-disc'",
        "'best-mattress-degenerative-disc', 'best-mattress-topper-back-pain'"
    )
...
card_check = 'href="posts/best-mattress-topper-back-pain.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-topper-back-pain.html">Best Mattress Topper for Back Pain</a></h3>\n'
    '          <p>7 picks with ILD firmness guide &mdash; when a topper helps vs. when to replace the mattress, pressure map data, and pain-type strategy table.</p>\n'
