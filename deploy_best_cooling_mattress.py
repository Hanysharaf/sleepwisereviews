...
# 2. CATEGORIES — Mattresses & Bedding
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-twin-xl'",
        "'best-mattress-twin-xl', 'best-cooling-mattress'"
    )
...
card_check = 'href="posts/best-cooling-mattress.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Mattresses &amp; Bedding</span>\n'
    '          <h3><a href="posts/best-cooling-mattress.html">Best Cooling Mattress</a></h3>\n'
    '          <p>7 mattresses ranked by cooling technology &mdash; GelFlex Grid, copper-infused foam, and open-coil airflow compared with a hot sleeper symptom guide.</p>\n'
