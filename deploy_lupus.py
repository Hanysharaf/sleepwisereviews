...
# 2. CATEGORIES — Health Conditions (after best-mattress-chronic-fatigue)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-chronic-fatigue'",
        "'best-mattress-chronic-fatigue', 'best-mattress-lupus'"
    )
...
card_check = 'href="posts/best-mattress-lupus.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Health Conditions</span>\n'
    '          <h3><a href="posts/best-mattress-lupus.html">Best Mattress for Lupus (SLE)</a></h3>\n'
    '          <p>7 picks for SLE joint pain, fatigue &amp; flares &mdash; pressure relief, cooling for temperature dysregulation, edge support for fatigue, and a flare vs remission phase guide.</p>\n'
