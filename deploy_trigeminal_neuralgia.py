slug = "best-mattress-trigeminal-neuralgia"
...
# 2. CATEGORIES (after best-mattress-cubital-tunnel-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-cubital-tunnel-syndrome'",
        "'best-mattress-cubital-tunnel-syndrome', 'best-mattress-trigeminal-neuralgia'"
    )
...
card_check = 'href="posts/best-mattress-trigeminal-neuralgia.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-trigeminal-neuralgia.html">Best Mattress for Trigeminal Neuralgia</a></h3>\n'
    '          <p>7 picks for trigeminal neuralgia &mdash; facial contact pressure elimination, thermal trigger avoidance, back-sleep elevation for V2/V3 branch, REM head-roll stabilization &amp; MVD post-surgical support.</p>\n'
