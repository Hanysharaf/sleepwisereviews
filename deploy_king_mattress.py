...
if slug not in gen:
    # Insert after best-queen-mattress in Mattresses & Bedding
    gen = gen.replace(
        "'best-queen-mattress'",
        "'best-queen-mattress', 'best-king-mattress'"
    )
...
card_check = 'href="posts/best-king-mattress.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Mattresses &amp; Bedding</span>\n'
    '          <h3><a href="posts/best-king-mattress.html">Best King Mattress</a></h3>\n'
    '          <p>The ultimate sleep upgrade — 7 top king mattress picks tested for couples, comfort, and every budget from $600 to $3,000+.</p>\n'
