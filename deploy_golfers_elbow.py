slug = "best-mattress-golfers-elbow"
...
# 2. CATEGORIES (after best-mattress-lateral-epicondylitis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-lateral-epicondylitis'",
        "'best-mattress-lateral-epicondylitis', 'best-mattress-golfers-elbow'"
    )
...
card_check = 'href="posts/best-mattress-golfers-elbow.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-golfers-elbow.html">Best Mattress for Golfer\'s Elbow</a></h3>\n'
    '          <p>7 picks for medial epicondylitis &mdash; FCR/FCU tendon pressure prevention, forearm supination stabilization during sleep, cubital tunnel co-management &amp; wrist flexor heat reduction.</p>\n'
