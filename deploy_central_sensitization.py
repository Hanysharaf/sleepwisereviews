...
# 2. CATEGORIES (after best-mattress-periodic-limb-movement)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-periodic-limb-movement'",
        "'best-mattress-periodic-limb-movement', 'best-mattress-central-sensitization'"
    )
...
card_check = 'href="posts/best-mattress-central-sensitization.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-central-sensitization.html">Best Mattress for Central Sensitization</a></h3>\n'
    '          <p>7 picks for CNS pain amplification &mdash; ultra-low pressure allodynia management, thermal dysregulation control, vibration sensitivity reduction &amp; foam pressure-hot-spot avoidance.</p>\n'
