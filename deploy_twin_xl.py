...
if slug not in gen:
    gen = gen.replace(
        "'best-twin-mattress'",
        "'best-twin-mattress', 'best-mattress-twin-xl'"
    )
...
card_check = 'href="posts/best-mattress-twin-xl.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Mattresses &amp; Bedding</span>\n'
    '          <h3><a href="posts/best-mattress-twin-xl.html">Best Twin XL Mattress</a></h3>\n'
    '          <p>7 Twin XL mattresses for dorms, adjustable split king bases, and tall sleepers &mdash; includes dorm clearance guide and split king setup table.</p>\n'
