...
# 2. CATEGORIES -- Health Conditions (after best-mattress-post-laminectomy-syndrome)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-post-laminectomy-syndrome'",
        "'best-mattress-post-laminectomy-syndrome', 'best-mattress-myasthenia-gravis'"
    )
...
card_check = 'href="posts/best-mattress-myasthenia-gravis.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-myasthenia-gravis.html">Best Mattress for Myasthenia Gravis</a></h3>\n'
    '          <p>7 picks for MG &mdash; head/neck support for cervical extensor weakness, respiratory semi-recumbent elevation, fatigue-sensitive repositioning, post-thymectomy safety &amp; immunosuppression-compatible materials.</p>\n'
