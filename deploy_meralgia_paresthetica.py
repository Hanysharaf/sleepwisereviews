...
# 2. CATEGORIES -- Health Conditions (after best-mattress-spondylolisthesis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-spondylolisthesis'",
        "'best-mattress-spondylolisthesis', 'best-mattress-meralgia-paresthetica'"
    )
...
card_check = 'href="posts/best-mattress-meralgia-paresthetica.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-meralgia-paresthetica.html">Best Mattress for Meralgia Paresthetica</a></h3>\n'
    '          <p>7 picks for lateral femoral cutaneous nerve entrapment &mdash; ASIS/inguinal ligament decompression in side-sleep, back-sleep knee elevation, hip-sinking prevention &amp; pregnancy/obesity latex buoyancy.</p>\n'
