...
if slug not in gen:
    gen = gen.replace(
        ...
        "'best-mattress-teenager', 'best-mattress-teen-athlete'"
    )
...
card_check = 'href="posts/best-mattress-teen-athlete.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-teen-athlete.html">Best Mattress for Teen Athletes</a></h3>\n'
    '          <p>7 picks for teenage athlete sleep &mdash; open growth plates, athletic recovery during rapid growth, adolescent circadian delay &amp; sport-specific pressure relief.</p>\n'
