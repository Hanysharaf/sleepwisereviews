slug = "best-mattress-huntingtons-disease"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-als)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-als'",
        "'best-mattress-als', 'best-mattress-huntingtons-disease'"
    )
...
card_check = 'href="posts/best-mattress-huntingtons-disease.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-huntingtons-disease.html">Best Mattress for Huntington\'s Disease</a></h3>\n'
    '          <p>7 picks for HD &mdash; sleep chorea absorption, REM behavior disorder, circadian disruption, HD cachexia bony prominence protection &amp; caregiver sleep.</p>\n'
