...
# 2. CATEGORIES -- Health Conditions (after best-mattress-mcas)
...
if slug not in gen:
    gen = gen.replace(
        "'best-mattress-mcas'",
        "'best-mattress-mcas', 'best-mattress-als'"
    )
...
card_check = 'href="posts/best-mattress-als.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-als.html">Best Mattress for ALS</a></h3>\n'
    '          <p>7 picks for ALS &mdash; NIV/BiPAP respiratory positioning, pressure injury prevention, spasticity dampening, caregiver access &amp; progressive disease stage guide.</p>\n'
