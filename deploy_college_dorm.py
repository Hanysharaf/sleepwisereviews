...
# 2. CATEGORIES — Life Stages (after best-mattress-bunk-beds)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-bunk-beds'",
        "'best-mattress-bunk-beds', 'best-mattress-college-dorm'"
    )
...
card_check = 'href="posts/best-mattress-college-dorm.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-college-dorm.html">Best Mattress for College Dorms</a></h3>\n'
    '          <p>7 picks under $500 &mdash; Twin XL sizing guide, bunk thickness rules, move-in day logistics, and what the dorm mattress is actually made of.</p>\n'
