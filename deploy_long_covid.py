...
# 2. CATEGORIES -- Health Conditions (after best-mattress-obesity)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-obesity'",
        "'best-mattress-obesity', 'best-mattress-long-covid'"
    )
...
card_check = 'href="posts/best-mattress-long-covid.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-long-covid.html">Best Mattress for Long COVID</a></h3>\n'
    '          <p>7 picks for long COVID sleep &mdash; post-exertional malaise (PEM) energy conservation, POTS positioning, dysautonomia cooling &amp; non-restorative sleep support.</p>\n'
