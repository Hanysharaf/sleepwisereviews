...
# 2. CATEGORIES -- add to couples-area (general lifestyle)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-athlete'",
        "'best-mattress-athlete', 'best-mattress-shift-workers'"
    )
...
card_check = 'href="posts/best-mattress-shift-workers.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge" style="background:#0e7490">Lifestyle</span>\n'
    '          <h3><a href="posts/best-mattress-shift-workers.html">Best Mattress for Shift Workers</a></h3>\n'
    '          <p>7 picks for night nurses, first responders &amp; factory workers &mdash; daytime cooling, household motion isolation, circadian disruption biology &amp; the 4 controllable sleep factors.</p>\n'
    '          <div class="card-meta"><span>7 picks</span><span>Lifestyle</span></div>\n'
    '        </div>\n'
    '        '
)
