...
# 2. CATEGORIES -- Health Conditions (after best-mattress-chronic-hives)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-chronic-hives'",
        "'best-mattress-chronic-hives', 'best-mattress-hashimotos'"
    )
...
card_check = 'href="posts/best-mattress-hashimotos.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-hashimotos.html">Best Mattress for Hashimoto\'s Thyroiditis</a></h3>\n'
    '          <p>7 picks for Hashimoto\'s &mdash; cold intolerance thermoregulation, autoimmune arthropathy, fatigue-paradox hyperarousal, levothyroxine sleep effects &amp; TSH titration phases.</p>\n'
