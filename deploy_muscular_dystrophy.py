slug = "best-mattress-muscular-dystrophy"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-cerebral-palsy)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-cerebral-palsy'",
        "'best-mattress-cerebral-palsy', 'best-mattress-muscular-dystrophy'"
    )
...
card_check = 'href="posts/best-mattress-muscular-dystrophy.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-muscular-dystrophy.html">Best Mattress for Muscular Dystrophy</a></h3>\n'
    '          <p>7 picks for DMD/BMD &mdash; BiPAP respiratory positioning, cardiomyopathy orthopnea, neuromuscular scoliosis, contracture pain &amp; progressive disease stage guide.</p>\n'
