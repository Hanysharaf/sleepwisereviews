...
# 2. CATEGORIES — Life Stages (after best-mattress-murphy-bed)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-murphy-bed'",
        "'best-mattress-murphy-bed', 'best-mattress-daybed'"
    )
...
card_check = 'href="posts/best-mattress-daybed.html"'
anchor = '<a class="article-card" href="posts/best-mattress-arthritis.html">'

card = (
    '        <div class="card-cat">\n'
    '          <span class="cat-badge">Life Stages</span>\n'
    '          <h3><a href="posts/best-mattress-daybed.html">Best Mattress for Daybeds</a></h3>\n'
    '          <p>7 picks with edge support guide &mdash; twin size confirmation, thickness by use case, and firmness balance for sitting during the day and sleeping at night.</p>\n'
