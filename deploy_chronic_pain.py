slug = "best-mattress-chronic-pain"
...
# 2. CATEGORIES -- Health Conditions (after best-mattress-lupus-nephritis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-lupus-nephritis'",
        "'best-mattress-lupus-nephritis', 'best-mattress-chronic-pain'"
    )
...
card_check = 'href="posts/best-mattress-chronic-pain.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-chronic-pain.html">Best Mattress for Chronic Pain</a></h3>\n'
    '          <p>7 picks for chronic pain &mdash; central sensitization, sleep-pain cycle, opioid-induced insomnia, widespread allodynia &amp; pain catastrophizing.</p>\n'
