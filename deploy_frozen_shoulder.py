...
# 2. CATEGORIES -- Health Conditions (after best-mattress-knee-pain)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-knee-pain'",
        "'best-mattress-knee-pain', 'best-mattress-frozen-shoulder'"
    )
...
card_check = 'href="posts/best-mattress-frozen-shoulder.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-frozen-shoulder.html">Best Mattress for Frozen Shoulder</a></h3>\n'
    '          <p>7 picks for adhesive capsulitis &mdash; GH joint decompression across freezing/frozen/thawing stages, motorized back-sleep elevation, REM movement stabilization &amp; stage-by-stage sleep position protocol.</p>\n'
