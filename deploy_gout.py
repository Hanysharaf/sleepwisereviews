...
# 2. CATEGORIES -- Health Conditions (after best-mattress-osteoarthritis)
with open("generate_posts_index.py", "r", encoding="utf-8") as f:
    gen = f.read()

if slug not in gen:
    gen = gen.replace(
        "'best-mattress-osteoarthritis'",
        "'best-mattress-osteoarthritis', 'best-mattress-gout'"
    )
...
card_check = 'href="posts/best-mattress-gout.html"'
...
card = (
    ...
    '          <h3><a href="posts/best-mattress-gout.html">Best Mattress for Gout</a></h3>\n'
    '          <p>7 picks for gout sleep &mdash; acute podagra flares, zero distal pressure, uric acid crystal triggers, tophaceous gout &amp; flare-remission cycles.</p>\n'
